            ...
            <div class="layui-card">
                <div class="layui-card-body ">
                    <form class="layui-form layui-col-space5">
                        ...
                        <div class="layui-inline layui-show-xs-block">
                            <button class="layui-btn" lay-submit="PageUserServlet" lay-filter="sreach"><i
                        ...
                        <c:forEach var="user" items="${pu.list}" varStatus="s">
                            <tr>
                                ...
                                <td class="td-manage">
                                    ...
                                    <a onclick="xadmin.open('修改密码','member-password.jsp?email=${user.email}',600,400)"
...
<script>
    ...
    function delAll(argument) {
        ...
        layer.confirm('确认要删除吗？', function (index) {
                ...
                location.href = "${pageContext.request.contextPath}/SelectDelServlet?emails=" + emails;
            }
        );
    }
</script>
