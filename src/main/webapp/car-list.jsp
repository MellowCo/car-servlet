            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body ">
                    <form class="layui-form layui-col-space5">
                        ...
                        <div class="layui-inline layui-show-xs-block">
                            <button class="layui-btn" lay-submit="PageCarServlet" lay-filter="sreach"><i
                    ...
                    <div class="page">
                        <div>
                            <c:if test="${pu.currentPage != 1}">
                                <a class="prev"
                                   href="PageCarServlet?currentPage=${pu.currentPage-1}&pageSize=5&cname=${mp.cname[0]}&crent=${mp.crent[0]}&status=${mp.status[0]}">&lt;&lt;</a>
                            </c:if>
                            ...
                            <c:forEach end="${pu.totalPage}" var="cpage" begin="1">
                                ...
                                <c:if test="${pu.currentPage != cpage}">
                                    <a class="num"
                                       href="PageCarServlet?currentPage=${cpage}&pageSize=5&cname=${mp.cname[0]}&crent=${mp.crent[0]}&status=${mp.status[0]}">${cpage}</a>
                                </c:if>
                            </c:forEach>
...
<script>
    ...
    function delAll(argument) {
        ...
        layer.confirm('确认要下架吗？', function (index) {
                location.href = "${pageContext.request.contextPath}/CarChangeSelectServlet?status=-1&cids=" + cids;
            }
        );
    }
